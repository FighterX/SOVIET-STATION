...
/obj/structure/table/update_icon()
	spawn(2) //So it properly updates when deleting
		...
		if (istype(src,/obj/structure/table/woodentable/clothed))
			switch(table_type)
				if(0)
					icon_state = "clothedwood"
				if(1)
					icon_state = "clothedwood_1tileendtable"
				if(2)
					icon_state = "clothedwood_1tilethick"
				if(3)
					icon_state = "clothedwooddir"
				if(4)
					icon_state = "clothedwood_middle"
				if(5)
					icon_state = "clothedwooddir2"
				if(6)
					icon_state = "clothedwooddir3"
		else if (istype(src,/obj/structure/table/reinforced/clothed) || istype (src,/obj/structure/table/clothed))		//Тупая система istype. Столы со скатерьтю считаются столами,а уже потом со скатертью.else if проверяет,получает положительный результат и выключается.
			switch(table_type)
				if(0)
					icon_state = "tabclothed"
				if(1)
					icon_state = "tabclothed_1tileendtable"
				if(2)
					icon_state = "tabclothed_1tilethick"
				if(3)
					icon_state = "tabclotheddir"
				if(4)
					icon_state = "tabclothed_middle"
				if(5)
					icon_state = "tabclotheddir2"
				if(6)
					icon_state = "tabclotheddir3"
...
/obj/structure/table/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	if (istype(W,/obj/item/weapon/cloth))
		new /obj/structure/table/clothed(src.loc)
		var/obj/item/weapon/cloth/Cl=W
		Cl.clothtab()
		del(src)
		return
...
/obj/structure/table/woodentable/attackby(obj/item/weapon/W as obj, mob/user as mob)
		if (istype(W,/obj/item/weapon/cloth))
			new/obj/structure/table/woodentable/clothed(src.loc)
			var/obj/item/weapon/cloth/Cl=W
			Cl.clothtab()
			del(src)
			return
...
/obj/structure/table/reinforced/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	if (istype(W,/obj/item/weapon/cloth))
		new /obj/structure/table/reinforced/clothed(src.loc)
		var/obj/item/weapon/cloth/Cl=W
		Cl.clothtab()
		del(src)
		return
