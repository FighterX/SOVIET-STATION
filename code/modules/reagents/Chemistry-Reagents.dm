...
#define SOLID 3
/datum/reagent/tea_liquid				//Знаю,что, по логике, он НЕ жидкий,но только так чайник примет.
	name="Tea leaves"
	id="tea_liquid"
	reagent_state=SOLID
	description="Some tea leaves"		//Ну,я ничего лучше не придумал.
	color="#693719"						//RGB:r=105,g=55,b=25	Лучше поменять
