...
/obj/item/clothing/under/leeshort1
	name = "Lee's shorts"
	desc = "The black-white Lee's shorts."
	icon_state = "lee_short1"
	item_state = "lee_short1"
	item_color = "lee_short1"

/obj/item/clothing/under/leeshort2
	name = "Lee's shorts"
	desc = "The white-black Lee's shorts."
	icon_state = "lee_short2"
	item_state = "lee_short2"
	item_color = "lee_short2"